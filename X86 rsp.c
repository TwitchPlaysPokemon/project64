...
void AdcConstToX86reg( int x86reg, BYTE Constant ) {
...
void MoveX86regPointerToX86regHalf(int Destination, int AddrReg) {
	...
	switch (AddrReg) {
	case x86_EAX: x86Amb = 0; break;
	case x86_EBX: x86Amb = 3; break;
	case x86_ECX: x86Amb = 1; break;
	case x86_EDX: x86Amb = 2; break;
	case x86_ESI: x86Amb = 6; break;
	case x86_EDI: x86Amb = 7; break;
	default: DisplayError("MoveX86regPointerToX86regHalf\nUnknown x86 Register");
	}

	switch (Destination) {
	case x86_EAX: x86Amb |= 0 << 3; break;
	case x86_EBX: x86Amb |= 3 << 3; break;
	case x86_ECX: x86Amb |= 1 << 3; break;
	case x86_EDX: x86Amb |= 2 << 3; break;
	case x86_ESI: x86Amb |= 6 << 3; break;
	case x86_EDI: x86Amb |= 7 << 3; break;
	default: DisplayError("MoveX86regPointerToX86regHalf\nUnknown x86 Register");
	}
